...
const MultiplicationSpaceThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] bg-gradient-to-br from-indigo-100 via-purple-50 to-blue-100 flex items-center justify-center p-10">
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="text-indigo-600 text-lg font-semibold mt-1">
            Numbers 1-5
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-6">
          ...
          <div className="flex gap-2">
            <div className="bg-indigo-50 rounded-lg p-2 flex flex-col items-center">
              <div className="text-sm text-indigo-600 mb-1">Station 1</div>
            ...
            <div className="bg-indigo-50 rounded-lg p-2 flex flex-col items-center">
              <div className="text-sm text-indigo-600 mb-1">Station 2</div>
              <div className="grid grid-cols-2 gap-1">
                <span className="text-xl">🚀</span>
                <span className="text-xl">🚀</span>
              </div>

...
const WordUnscrambleThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-blue-300 to-indigo-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center">
        <h1 className="text-xl font-bold text-blue-600 mb-2 text-center font-system">
          Action Words Fun
        </h1>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-base text-gray-500 font-system">RUN</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-1 relative">
            {['N', 'U', 'R'].map((letter) => (
              <div
                key={letter}
                className="w-8 h-8 rounded-lg bg-white shadow-md flex items-center justify-center border-2 border-blue-200"
              >
        ...
        <p className="text-sm text-gray-600 mt-4 text-center font-system">
          Learn action words through fun unscrambling!
        </p>
      </div>
    </div>
  );

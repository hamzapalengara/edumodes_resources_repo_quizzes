...
const PlaytimeThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-6">
        ...
        <h1 className="text-3xl font-bold text-white text-center mb-6">
          Playtime Words Spelling
        </h1>

        {/* Word pattern showcase */}
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-all</div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-ame</div>
            <div className="flex gap-2 justify-center">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-ike</div>
            <div className="flex gap-2 justify-center">
...
export default PlaytimeThumbnail; 
...
const LetterRecognitionWorksheet: React.FC = () => {
      ...
      if (isRequestingSummary) {
        ...
        const summary: WorksheetSummary = {
          summary: {
            ...
            correct_answers: incorrectAnswers,
            incorrect_answers: incorrectAnswers,
            total_score: (incorrectAnswers / maxScore) * 100,
  ...
  }, [incorrectAnswers, totalQuestions, maxScore, startTime]);
  ...
  const handleLetterInput = (index: number, value: string) => {
    ...
    if (letter.isHidden) {
      ...
      if (letter.isCorrect) {
        setIncorrectAnswers(prev => Math.max(prev - 10, 0));
        setShowSuccess(true);
  ...
  return (
    <WorksheetTracker totalQuestions={totalQuestions}>

...
const FootballMultiplicationWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Initial instruction
    setTimeout(() => {
      speak("Welcome to Football Multiplication! Match the problems with their answers to score goals!");
    }, 1000);
  ...
  return (
    <WorksheetTracker 
      ...
      onSummaryGenerated={(summary: WorksheetSummary) => {
        console.log('Football Multiplication Summary:', summary);
      }}
    >
          ...
          if (!selectedTile) {
            ...
            if (selectedTile.id !== tile.id && isMatch) {
              ...
              if (matchedPairs.length + 1 === 10) {
                ...
                setTimeout(() => {
                  speak("Amazing! You've scored all the goals and mastered the 2 times table!");
                }, 1000);
              }
            } else {
              ...
              speak("Not quite! Try another match to score a goal!");
            }
              ...
              <div className="px-0 md:px-4">
                ...
                <div className="bg-green-800 rounded-lg p-2 md:p-4 mb-4 text-white">
                  <h1 className="text-xl md:text-2xl font-bold text-center mb-3">
                    Football Multiplication: 2 Times Table ⚽
                  </h1>
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="relative aspect-[3/4] w-full rounded-lg overflow-hidden bg-green-800 shadow-lg">
                      ...
                      <div className="absolute inset-0">
                        <div className="w-full h-full grid grid-rows-10 grid-cols-2">
                          {tiles.map((tile) => (
                            <div 
                              key={tile.id}
                              style={{ 
...
export default FootballMultiplicationWorksheet; 
...
const dialogues: Dialogue[] = [
  {
    ...
    emoji: '⚾',
    expectedResponse: "Yes dad I am ready to play"
  },
  {
    id: 2,
    speaker: 'dad',
    ...
    emoji: '📚',
    expectedResponse: "Yes I finished all my homework"
  },
  {
    id: 3,
    speaker: 'dad',
    ...
    emoji: '🏃',
    expectedResponse: "Okay I will warm up with you"
  },
  {
    id: 4,
    speaker: 'dad',
    ...
    emoji: '🎯',
    expectedResponse: "Yes I want to throw farther"
  },
  {
    id: 5,
    speaker: 'dad',
    ...
    emoji: '🌟',
    expectedResponse: "Thank you dad I am practicing"
  },
  {
    id: 6,
    speaker: 'dad',
    ...
    emoji: '💧',
    expectedResponse: "Yes I am thirsty thank you"
  }
];

const SpeakingDadWorksheet: React.FC = () => {
  ...
  // Play dad's voice on initial load
  useEffect(() => {
    if (activeDialogueIndex === 0) {
      speakDadText(dialogues[activeDialogueIndex].text);
    }
  }, []);
  ...
  const speakDadText = (text: string) => {
              ...
              if (!completedDialogues[activeDialogueIndex]) {
                ...
                setTimeout(() => {
                  ...
                  if (nextIndex < dialogues.length) {
                    ...
                    setSpokenText('');
                    speakDadText(dialogues[nextIndex].text);
                  }
                }, 1500);
              }
            }
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="bg-blue-50 rounded-lg p-3">
                              ...
                              <motion.button
                                onClick={() => speakDadText(dialogue.text)}
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="bg-green-50 rounded-lg p-3">
                              ...
                              {isEditing && activeDialogueIndex === index ? (
                                ...
                                <p className="text-base md:text-lg font-semibold text-green-800 min-h-[2rem] break-words">
...
export default SpeakingDadWorksheet; 
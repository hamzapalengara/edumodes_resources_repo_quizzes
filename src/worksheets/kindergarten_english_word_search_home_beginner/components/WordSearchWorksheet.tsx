...
// Home-themed 3-4 letter words suitable for kindergarten
const WORD_LIST = [
  { word: 'BED', emoji: '🛏️' },
  { word: 'SOFA', emoji: '🛋️' },
  { word: 'LAMP', emoji: '💡' },
...
const WORD_COLORS = [
  { bg: 'bg-rose-200', text: 'text-rose-800' },     // Bedroom
  { bg: 'bg-amber-200', text: 'text-amber-800' },   // Living Room
  { bg: 'bg-yellow-200', text: 'text-yellow-800' }, // Lighting
  { bg: 'bg-brown-200', text: 'text-brown-800' },   // Entry
  { bg: 'bg-blue-200', text: 'text-blue-800' },     // Kitchen
  { bg: 'bg-cyan-200', text: 'text-cyan-800' },     // Bathroom
  { bg: 'bg-green-200', text: 'text-green-800' },   // Space
  { bg: 'bg-purple-200', text: 'text-purple-800' }, // Play
  { bg: 'bg-orange-200', text: 'text-orange-800' }, // Dining
  { bg: 'bg-teal-200', text: 'text-teal-800' },     // Kitchen Activity
];
...
const WordSearchWorksheet: React.FC = () => {
  ...
  const handleTouchMove = (e: React.TouchEvent) => {
    ...
    // If we're not over a cell, ignore the touch
    ...
    // If it's the same cell as last time, ignore
          ...
          <div className="px-0 md:px-4 max-w-4xl mx-auto">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 mb-4">
              ...
              <div className="text-center mb-3">
                <p className="text-white text-lg font-medium">
                  Find these home words in the grid below! 🔍
                </p>
                    ...
                    return (
                      <motion.div
                        ...
                        className={`
                          ...
                          ${cell.isSelected ? 'bg-blue-300 text-blue-800' : 
                            wordPosition ? `${WORD_COLORS[colorIndex].bg} ${WORD_COLORS[colorIndex].text}` :
                            'bg-white text-gray-700'}
                          ${cell.isPartOfWord ? 'hover:bg-blue-100' : ''}
                        `}
            ...
            {isComplete && (
              ...
              >
                ...
                <p>You've found all the home words!</p>
              </motion.div>
            )}
          </div>
        )}

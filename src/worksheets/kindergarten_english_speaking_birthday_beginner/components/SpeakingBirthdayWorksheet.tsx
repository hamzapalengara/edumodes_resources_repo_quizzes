...
const dialogues: Dialogue[] = [
  {
    id: 1,
    speaker: 'you',
    text: "Hi Sarah! I have something exciting to tell you!",
    emoji: '😊',
    expectedResponse: "Hi what is the exciting news"
  },
  {
    id: 2,
    speaker: 'you',
    text: "It's my birthday party this Saturday! Would you like to come?",
    emoji: '🎂',
    expectedResponse: "That sounds fun when is the party"
  },
  {
    id: 3,
    speaker: 'you',
    text: "It starts at 2 o'clock in the afternoon at my house!",
    emoji: '🕑',
    expectedResponse: "What activities will we do at the party"
  },
  {
    id: 4,
    speaker: 'you',
    text: "We'll have games, cake, and a bouncy castle!",
    emoji: '🎮',
    expectedResponse: "That sounds really exciting I would love to come"
  },
  {
    id: 5,
    speaker: 'you',
    text: "Great! We're also having face painting and a magician!",
    emoji: '🎪',
    expectedResponse: "Should I bring anything to the party"
  },
  {
    id: 6,
    speaker: 'you',
    text: "Just bring yourself! And wear something comfortable for playing!",
    emoji: '👕',
    expectedResponse: "What time does the party finish"
  },
  {
    id: 7,
    speaker: 'you',
    text: "The party ends at 5 o'clock. Your parents can pick you up then!",
    emoji: '🚗',
    expectedResponse: "Can my little sister come too"
  },
  {
    id: 8,
    speaker: 'you',
    text: "Of course! The more friends, the more fun!",
    emoji: '👧',
    expectedResponse: "Thank you for inviting us to your party"
  },
  {
    id: 9,
    speaker: 'you',
    text: "I'll give you an invitation card with all the details!",
    emoji: '💌',
    expectedResponse: "Can you write your address on the card"
  },
  {
    id: 10,
    speaker: 'you',
    text: "Yes, I'll write everything you need to know. See you Saturday!",
    emoji: '✨',
    expectedResponse: "See you on Saturday I am so excited"
  }
];

const SpeakingBirthdayWorksheet: React.FC = () => {
  ...
  // Play your voice on initial load
  useEffect(() => {
    if (activeDialogueIndex === 0) {
      speakYourText(dialogues[activeDialogueIndex].text);
    }
  }, []);
  ...
  const speakYourText = (text: string) => {
    ...
    const voices = window.speechSynthesis.getVoices();
    const yourVoice = voices.find(voice => 
      voice.lang.startsWith('en-') && 
      voice.name.toLowerCase().includes('female')
    );
    
    if (yourVoice) {
      utterance.voice = yourVoice;
    }

    window.speechSynthesis.speak(utterance);
  };

  const speakFriendResponse = (text: string) => {
    if (!('speechSynthesis' in window)) return;
    ...
    const voices = window.speechSynthesis.getVoices();
    const friendVoice = voices.find(voice => 
      voice.lang.startsWith('en-') && 
      voice.name.toLowerCase().includes('female')
    );
              ...
              if (!completedDialogues[activeDialogueIndex]) {
                ...
                setTimeout(() => {
                  ...
                  if (nextIndex < dialogues.length) {
                    ...
                    setSpokenText('');
                    speakYourText(dialogues[nextIndex].text);
                  }
                }, 1500);
              }
            }
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg mx-2 md:mx-4">
                  <h1 className="text-xl md:text-2xl font-bold text-center text-blue-600 p-4 border-b border-blue-100">
                    Speaking Practice: Inviting to a Birthday Party
                  </h1>
                      ...
                      >
                        ...
                        <div className="flex items-start gap-3 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="bg-blue-50 rounded-lg p-3">
                              ...
                              <motion.button
                                onClick={() => speakYourText(dialogue.text)}
                        ...
                        {completedDialogues[index] && lastSpokenResponse && (
                          <div className="mt-3 flex justify-end">
                            <motion.button
                              onClick={() => speakFriendResponse(lastSpokenResponse)}
...
export default SpeakingBirthdayWorksheet; 
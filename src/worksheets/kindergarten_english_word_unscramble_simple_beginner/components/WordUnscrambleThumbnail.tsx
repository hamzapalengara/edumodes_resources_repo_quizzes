      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-xl p-6 relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center space-y-4">
          ...
          <p className="text-sm text-gray-600 text-center">
            Learn vegetable words through fun unscrambling!
          </p>
          ...
          <div className="flex space-x-2">
            {[1, 2, 3].map((level, index) => (
              <motion.div
                key={level}
                className="w-8 h-8 bg-purple-100 rounded-full text-sm text-purple-600 font-bold flex items-center justify-center"

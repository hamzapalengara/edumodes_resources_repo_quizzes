...
import cartoonImage from '../assets/cartoon-scene.jpg';
...
const CartoonLetterMatchingWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Initial instruction with cartoon theme
    setTimeout(() => {
      speak("Welcome to the Letter Chase! Help Tom and Jerry find matching letters. Ready to start?");
    }, 1000);
  ...
  return (
    <WorksheetTracker 
      ...
      onSummaryGenerated={(summary: WorksheetSummary) => {
        console.log('Cartoon Letter Matching Summary:', summary);
      }}
    >
        ...
        const handleTileClick = (tile: LetterTile) => {
          ...
          if (!selectedTile) {
            ...
            if (selectedTile.id !== tile.id && 
              ...
              speak(`Great catch! You matched the letter ${tile.letter.toUpperCase()}`);
              
              if (matchedPairs.length + 1 === 8) {
                setShowConfetti(true);
                setTimeout(() => setShowConfetti(false), 8000);
                setTimeout(() => {
                  speak("Amazing! You've helped Tom and Jerry find all the matching letters!");
                }, 1000);
              }
            } else {
              ...
              speak("Oops! Try again to find the matching pair.");
            }
              ...
              <div className="px-0 md:px-4">
                ...
                <div className="bg-blue-800 rounded-lg p-2 md:p-4 mb-4 text-white">
                  <h1 className="text-xl md:text-2xl font-bold text-center mb-3">
                    Letter Chase with Tom and Jerry 🐱🐭
                  </h1>

                  <div className="bg-blue-700 rounded p-2 md:p-3">
                    <p className="font-medium">✨ Mission:</p>
                    <p>Help Tom and Jerry find matching capital and small letters!</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="relative aspect-[3/4] w-full rounded-lg overflow-hidden bg-blue-800 shadow-lg">
                      <img 
                        src={cartoonImage}
                        alt="Tom and Jerry Scene"
                        className="absolute inset-0 w-full h-full object-cover"
                      />
                      
                      {/* Grid container with equal divisions */}
                      <div className="absolute inset-0">
                        <div className="w-full h-full grid grid-rows-[repeat(8,1fr)] grid-cols-2">
                          {tiles.map((tile) => (
                            <div 
                              key={tile.id}
                              style={{ 
                  ...
                  <div className="hidden md:flex w-1/2 flex-col gap-4">
                    <div className="bg-blue-800 p-4 rounded-lg">
                      ...
                      <ul className="text-blue-100 space-y-2">
                        ...
                        <li>3. Match all pairs to help Tom and Jerry!</li>
                      </ul>
                    </div>
...
export default CartoonLetterMatchingWorksheet; 
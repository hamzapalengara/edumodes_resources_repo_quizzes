...
const WORD_LIST = [
  { word: 'COOK', pattern: '-ook', hint: 'Mom or dad preparing food' },
  { word: 'BOOK', pattern: '-ook', hint: 'Reading stories at home' },
  { word: 'LOOK', pattern: '-ook', hint: 'Viewing family photos' },
  { word: 'FOOD', pattern: '-ood', hint: 'Eating together with family' },
  { word: 'GOOD', pattern: '-ood', hint: 'Nice habits at home' },
  { word: 'WOOD', pattern: '-ood', hint: 'What furniture is made of' },
  { word: 'NEST', pattern: '-est', hint: 'Bird home in a tree' },
  { word: 'REST', pattern: '-est', hint: 'Taking a break at home' },
  { word: 'VEST', pattern: '-est', hint: 'A piece of clothing' }
];
...
const HomeWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    if (!hasPlayedIntro && words.length > 0) {
      speak("Welcome to home spelling! Let's learn four-letter words about home. Click the speaker to hear each word.");

...
const RHYME_GROUPS = [
  {
    pattern: '-ook',
    words: ['COOK', 'BOOK', 'LOOK'],
    example: 'These words rhyme because they all end with the "ook" sound.',
    hints: [
      'Mom or dad preparing food',
  ...
  {
    pattern: '-ood',
    words: ['FOOD', 'GOOD', 'WOOD'],
    example: 'These words rhyme because they all end with the "ood" sound.',
    hints: [
  ...
  {
    pattern: '-est',
    words: ['NEST', 'REST', 'VEST'],
    example: 'These words rhyme because they all end with the "est" sound.',
    hints: [
      'Bird home in a tree',

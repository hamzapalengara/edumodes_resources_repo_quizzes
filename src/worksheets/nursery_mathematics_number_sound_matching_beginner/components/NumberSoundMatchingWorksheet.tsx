...
const NumberSoundMatchingWorksheet: React.FC = () => {
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="mb-6 text-center">
                    <div className="inline-flex items-center gap-2 bg-indigo-100 px-4 py-2 rounded-full">
                      <span className="text-sm font-medium text-indigo-900">Question:</span>
                      <span className="text-sm font-bold text-indigo-900">{currentQuestionIndex + 1} / {TOTAL_QUESTIONS}</span>
                    </div>
                  </div>
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${isWorksheetCompleted
                            ...
                            : 'bg-white hover:bg-indigo-50 active:bg-indigo-100 text-indigo-900'
                          }
                  ...
                  {showFinalCelebration && (
                    <div className="fixed inset-0 bg-indigo-900/50 backdrop-blur-sm flex items-center justify-center z-40">
...
export default NumberSoundMatchingWorksheet; 
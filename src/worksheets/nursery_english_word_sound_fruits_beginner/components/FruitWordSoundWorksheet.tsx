...
const FruitWordSoundWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Initial instruction
    setTimeout(() => {
      speak("Welcome! Listen to the fruit name and choose the correct word. Click the speaker to hear it again!");
    }, 1000);
            ...
            <TouchContainer>
              <div className="px-0 md:px-4">
                ...
                <div className="bg-white rounded-lg p-4 shadow-lg mb-6">
                  <h1 className="text-2xl md:text-3xl font-bold text-center text-orange-600 mb-2">
                ...
                <div className="bg-white rounded-lg p-6 shadow-lg mb-6">
                  <div className="flex flex-col items-center gap-6">
                    ...
                    <button
                      ...
                      className="w-24 h-24 bg-gradient-to-r from-orange-500 to-red-500 rounded-full shadow-lg flex items-center justify-center transform hover:scale-105 transition-all"
                    >
...
export default FruitWordSoundWorksheet; 
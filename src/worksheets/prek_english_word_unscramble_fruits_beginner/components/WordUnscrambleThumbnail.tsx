...
const WordUnscrambleThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-pink-300 to-orange-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-base text-gray-500 font-system">APPLE</span>
        </div>
        ...
        <p className="text-sm text-gray-600 mt-4 text-center font-system">
          Learn fruit words through fun unscrambling!
        </p>
      </div>
    </div>
  );

...
const LetterTracingThumbnail: React.FC = () => {
  ...
  return (
    <div className="w-[500px] h-[375px] bg-gradient-to-b from-sky-50 via-cyan-100 to-blue-200 overflow-hidden flex items-center justify-center">
      {/* Inner Content Container */}
      <div className="w-[420px] h-[240px] bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border-2 border-blue-100/50 p-6">
        {/* Header */}
        ...
        <div className="text-center mb-4">
          <h1 className="text-2xl font-bold text-blue-800 mb-1">Ocean Letter Adventure</h1>
          <p className="text-sm text-blue-700">Learn to write uppercase letters with sea creatures!</p>
        </div>
        ...
        <div className="flex justify-center gap-3 mb-4">
          {previewLetters.map((letter: Letter) => (
            <div key={letter.char} className="relative">
              <div className="w-16 h-16 bg-white rounded-lg shadow-md flex flex-col items-center justify-center border border-blue-100">
                <span className="text-3xl font-bold text-blue-800">{letter.char}</span>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-2">
            <div className="flex items-center gap-0.5">
              ...
              <span className="text-xs text-blue-800 font-medium">Interactive</span>
            </div>
            <div className="flex items-center gap-0.5">
              <span className="text-base">🔊</span>
              <span className="text-xs text-blue-800 font-medium">Voice Guide</span>
            </div>
          </div>

    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-pink-100 to-yellow-100 flex items-center justify-center p-4">
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center gap-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">
          Build Daily Conversation Sentences
        </h1>
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex items-center gap-2 text-blue-600">
            <span className="font-mono">How are you</span>
            <span>→</span>
            <span className="font-mono">Thank you</span>
          </div>
          <div className="text-sm text-gray-600">
            Build simple sentences from daily conversations
          </div>
        </div>
      </div>
    </div>

        ...
        <div className="bg-white shadow-md border-y-2 border-pink-100">
          ...
          <section className="py-6 border-t border-pink-100">
            ...
            <ul className="space-y-3 px-4">
              <li className="flex items-start">
                ...
                <span>Each flower has a picture and a helpful hint</span>
              </li>
              <li className="flex items-start">
                <span className="text-pink-500 mr-2">🎯</span>
          ...
          <section className="py-6 border-t border-pink-100">
            ...
            <ul className="space-y-3 px-4">
              <li className="flex items-start">
                <span className="text-pink-500 mr-2">🌺</span>
                <span>Use this as an opportunity to discuss different types of flowers</span>
              </li>
              <li className="flex items-start">
                <span className="text-pink-500 mr-2">🎓</span>
              ...
              <li className="flex items-start">
                <span className="text-pink-500 mr-2">🌟</span>
                <span>Encourage learning about flowers in nature and gardens</span>
              </li>
            </ul>
          </section>

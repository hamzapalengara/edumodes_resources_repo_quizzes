...
const NumberFourThumbnail: React.FC = () => {
  return (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="w-16 h-16 bg-indigo-50 rounded-xl flex items-center justify-center relative">
                <span className="text-4xl font-bold text-indigo-900">4</span>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-1">
                ...
                <div className="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center">
                  <span className="text-lg font-bold text-indigo-900">4 🍓</span>
                </div>
              </div>
            </div>
          </div>
...
export default NumberFourThumbnail; 
...
const FirstLetterWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    if (activeWordIndex >= words.length && !isComplete) {
      setIsComplete(true);
      // Nature-themed celebration colors
      const celebrationColors = ['#4CAF50', '#8BC34A', '#FFC107'];
        ...
        {({ score, markCorrect, markAttempted }) => {
          const handleOptionClick = (letter: string) => {
            ...
            if (letter === currentWord.correctLetter) {
              if (!completedWords[activeWordIndex]) {
                ...
                // Success confetti with nature colors
                confetti({
                  particleCount: 50,
                  spread: 70,
                  origin: { y: 0.7 },
          ...
          return (
            <div className="w-full px-0 md:px-4 max-w-4xl mx-auto py-6">
              ...
              <div className="bg-white rounded-lg shadow-md mb-6 overflow-hidden border-2 border-green-100">
                {/* Score Display */}
                ...
                <div className="border-t border-green-100">
                  <button
                    ...
                    className="w-full px-4 py-3 text-left text-green-800 font-semibold flex items-center justify-between hover:bg-green-50 transition-colors"
                  >
                  ...
                  {showInstructions && (
                    <div className="px-4 py-3 text-gray-700 bg-green-50/50">
                      <ul className="list-disc list-inside space-y-2">
                        <li>Listen to the animal word carefully</li>
              ...
              <div className="min-h-[400px] relative">
                  ...
                  <div className="bg-white rounded-lg p-6 shadow-md border-2 border-green-100">
                    <div className="flex flex-col items-center gap-6">
                      ...
                      <motion.button
                        ...
                        className="bg-green-100 text-green-700 px-8 py-3 rounded-full flex items-center gap-2 text-lg shadow-md hover:bg-green-200 transition-colors"
                      ...
                      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
                        {shuffledOptions[activeWordIndex].map((letter, letterIndex) => (
                          <motion.button
                            ...
                            className="bg-green-500 text-white text-2xl font-bold py-4 px-6 rounded-xl shadow-md hover:bg-green-600 transition-colors"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                          >
                            {letter.toUpperCase()}
                ...
                {isComplete && (
                  <motion.div 
                    ...
                    className="bg-white p-8 rounded-lg shadow-lg text-center space-y-6 border-2 border-green-100"
                  >
                    ...
                    >
                      <p className="text-lg text-green-700">
                        You're amazing at finding animal word sounds!
                      </p>
                      <div className="flex justify-center items-center gap-2 text-lg">
                        <span className="text-green-700">Your Score:</span>
                        <span className="font-bold text-2xl bg-green-100 px-4 py-1 rounded-full text-green-800">
                    ...
                    <motion.div 
                      ...
                      className="bg-green-50 rounded-lg p-6 mt-6 max-w-md mx-auto"
                    >
                      ...
                      <ul className="text-left space-y-3">
                        ...
                        >
                          ...
                          <span>Animal Word Recognition</span>
                        </motion.li>
                        <motion.li 
                          initial={{ x: -20, opacity: 0 }}
                          animate={{ x: 0, opacity: 1 }}
                    ...
                    <motion.div 
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      transition={{ delay: 1 }}
                      className="text-green-600 mt-6 font-medium text-lg"
                    >
                      Ready to explore more animal sounds? Keep going!
                    </motion.div>
                  </motion.div>
                )}
              </div>

...
const TransportThumbnail: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            ...
            <div className="flex flex-col gap-1 items-center">
              <span className="text-white">BIKE • SHIP</span>
              <span className="text-white">TAXI • ROAD</span>
            </div>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
...
export { TransportThumbnail as default }; 
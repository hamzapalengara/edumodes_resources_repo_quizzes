...
const TransportWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    if (!hasPlayedIntro && words.length > 0) {
      speak("Welcome to transport spelling! Let's learn words about vehicles and travel. Click the speaker to hear each word.");
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="text-blue-600">
                                Letters: {words[currentWordIndex]?.letters.length}
                              </div>
                            </div>
                          </div>
...
export default TransportWorksheet; 
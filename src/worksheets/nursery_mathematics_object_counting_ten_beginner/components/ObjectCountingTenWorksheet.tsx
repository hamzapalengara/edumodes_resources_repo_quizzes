...
const ObjectCountingTenWorksheet: React.FC = () => {
      ...
      {({ markCorrect, markAttempted, score }) => {
        ...
        const handleOptionClick = useCallback((selectedNumber: string) => {
          ...
          if (parseInt(selectedNumber) === currentQuestion.count) {
            ...
            setShowSuccess(true);
            speak(`Excellent! Yes, there are ${currentQuestion.count} objects!`);
          ...
          <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-emerald-50 to-cyan-100">
            ...
            <div className="bg-white/30 backdrop-blur-md shadow-lg border border-emerald-200">
              <div className="max-w-4xl mx-auto px-2 py-2 md:px-4 md:py-3 flex flex-col items-stretch gap-2">
                ...
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-emerald-900 text-center">
                  Count Objects and Match Numbers (5-10)
                </h2>
              </div>
            </div>
            ...
            {/* Main Content */}
            <main className="px-0">
              <div className="bg-white/30 backdrop-blur-md p-2 md:p-4 mb-2 md:mb-4 shadow-lg border border-emerald-200">
                <div className="max-w-4xl mx-auto">
                  ...
                  {/* Question Section */}
                  <div className="mb-8">
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-emerald-200 shadow-lg text-center">
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${isWorksheetCompleted
                            ...
                            : 'bg-white hover:bg-emerald-50 active:bg-emerald-100 text-emerald-900'
                          }
                          shadow-lg border-2 border-emerald-200 hover:border-cyan-300
                          backdrop-blur-sm
                        `}
                      >
                        {option}
                  ...
                  {showFinalCelebration && (
                    <div className="fixed inset-0 bg-emerald-900/80 backdrop-blur-sm flex items-center justify-center z-40">
                      <div className="bg-white rounded-2xl p-8 max-w-md mx-4 text-center shadow-2xl transform animate-bounce border-2 border-emerald-200">
                    ...
                    <motion.div
                      ...
                      style={{
                        ...
                        color: item.type === 'emoji' ? 'inherit' : 
                               `hsl(${160 + Math.random() * 40}, ${70 + Math.random() * 20}%, ${65 + Math.random() * 15}%)`,
                        textShadow: '0 0 5px rgba(0,0,0,0.2)',
                        fontSize: item.type === 'emoji' ? '2.5rem' : '2rem',
                        fontWeight: 'bold',
                      }}
                    >
                      {item.type === 'emoji' ? questions[currentQuestionIndex].objects[0] : questions[currentQuestionIndex].count}
                    </motion.div>
                  ))}
                </div>
              )}
...
export default ObjectCountingTenWorksheet; 
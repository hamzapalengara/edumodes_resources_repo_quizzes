...
const dialogues: Dialogue[] = [
  {
    id: 1,
    speaker: 'seller',
    text: "Welcome to Sweet Treats! How can I help you today?",
    emoji: '🍦',
    expectedResponse: "Hi I would like to buy some ice cream please"
  },
  {
    id: 2,
    speaker: 'seller',
    text: "Sure! We have chocolate, vanilla, strawberry, and mint. What flavor would you like?",
    emoji: '🍫',
    expectedResponse: "Can I have chocolate ice cream please"
  },
  {
    id: 3,
    speaker: 'seller',
    text: "Would you like it in a cup or cone?",
    emoji: '🍦',
    expectedResponse: "I would like it in a cone please"
  },
  {
    id: 4,
    speaker: 'seller',
    text: "Would you like any toppings? We have sprinkles, nuts, and chocolate chips.",
    emoji: '🌈',
    expectedResponse: "Yes I would like sprinkles on top please"
  },
  {
    id: 5,
    speaker: 'seller',
    text: "That will be three dollars, please.",
    emoji: '💵',
    expectedResponse: "Here is three dollars thank you"
  },
  {
    id: 6,
    speaker: 'seller',
    text: "Here's your ice cream with sprinkles. Enjoy!",
    emoji: '🍦',
    expectedResponse: "Thank you very much have a nice day"
  },
  {
    id: 7,
    speaker: 'seller',
    text: "Would you like a napkin with that?",
    emoji: '🧻',
    expectedResponse: "Yes please that would be helpful"
  },
  {
    id: 8,
    speaker: 'seller',
    ...
    emoji: '❓',
    expectedResponse: "No thank you that is all I need"
  },
  {
    id: 9,
    speaker: 'seller',
    text: "Please come again! We have new flavors every week.",
    emoji: '👋',
    expectedResponse: "I will come back to try new flavors thank you"
  },
  {
    id: 10,
    speaker: 'seller',
    text: "Have a sweet day! Bye bye!",
    emoji: '😊',
    expectedResponse: "Goodbye have a nice day too"
  }
];

const SpeakingIcecreamWorksheet: React.FC = () => {
...
export default SpeakingIcecreamWorksheet; 
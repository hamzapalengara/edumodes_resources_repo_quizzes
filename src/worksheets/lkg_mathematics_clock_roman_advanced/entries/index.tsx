...
const Worksheet = lazy(() => import('../components/ClockRomanAdvancedWorksheet'));
const AnswerKey = lazy(() => import('../components/ClockRomanAdvancedAnswerKey'));
const Tips = lazy(() => import('../components/ClockRomanAdvancedTips'));
const Thumbnail = lazy(() => import('../components/ClockRomanAdvancedThumbnail'));

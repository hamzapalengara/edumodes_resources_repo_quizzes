...
const TIME_QUESTIONS = [
  ...
  },
  {
    hours: 6,
    minutes: 45,
    options: ['Quarter to VII', 'Quarter past VI', 'Half past VI'],
    correctAnswer: 'Quarter to VII'
  },
  {
    hours: 12,
    minutes: 30,
  ...
  },
  {
    hours: 11,
    minutes: 45,
    options: ['Quarter to XII', 'Half past XI', 'Quarter past XI'],
    correctAnswer: 'Quarter to XII'
  }
];

const ClockRomanAdvancedWorksheet: React.FC = () => {
  ...
  const provideFeedback = (isCorrect: boolean, time?: string) => {
    if (isCorrect && time) {
      ...
      speak("Try again! Look carefully at the clock hands and Roman numerals.");
    }
  };
...
export default ClockRomanAdvancedWorksheet; 
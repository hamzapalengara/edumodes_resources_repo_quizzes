...
const NumberOrderingThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-indigo-300 to-purple-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold text-indigo-600 mb-2 text-center font-system">
          Order Numbers 10-15
        </h1>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-lg text-gray-500 font-system">15</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2 relative">
            {[12, 15, 10, 14, 11, 13].map((num) => (
              <div
                key={num}
                className="w-8 h-8 rounded-lg bg-white shadow-md flex items-center justify-center border-2 border-indigo-200"
              >
                <span className="text-base font-bold text-indigo-600">{num}</span>
              </div>
            ))}

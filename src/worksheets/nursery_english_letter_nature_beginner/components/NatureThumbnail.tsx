...
const NatureThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] relative overflow-hidden">
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-500/80 via-blue-500/80 to-purple-500/80" />

      {/* Content container */}
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-6">
        {/* Title */}
        <h1 className="text-3xl font-bold text-white text-center mb-6">
          Nature Words Spelling
        </h1>

        {/* Word pattern showcase */}
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-ree</div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-ain</div>
            <div className="flex gap-2 justify-center">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="text-xl font-bold text-white mb-2">-ind</div>
            <div className="flex gap-2 justify-center">
...
export default NatureThumbnail; 
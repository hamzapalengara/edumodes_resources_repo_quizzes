            ...
            <section className="max-w-md mx-auto bg-blue-50 p-4 rounded-lg">
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start">
                  ...
                  <div>
                    <p className="font-semibold">Start at the Top</p>
                    <p className="text-sm mt-1">Always begin writing from the top dot</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-green-100 rounded-full mr-3">
                  ...
                  <div>
                    <p className="font-semibold">Draw Straight Down</p>
                    <p className="text-sm mt-1">Keep your line as straight as possible</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-green-100 rounded-full mr-3">
                  ...
                  <div>
                    <p className="font-semibold">Add the Small Line</p>
                    <p className="text-sm mt-1">Draw a small diagonal line at the top</p>
                  </div>
                </li>
              </ul>
            </section>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg text-gray-700">
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center">
                    ...
                    Practice each step until you feel confident
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-yellow-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />

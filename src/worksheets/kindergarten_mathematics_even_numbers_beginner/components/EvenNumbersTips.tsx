          ...
          <div className="space-y-6">
            ...
            <div className="bg-indigo-50 rounded-xl p-4">
              ...
              <div className="bg-white rounded-xl p-4 text-purple-700">
                <p className="italic">
                  "Two and four and six and eight,<br />
                  Ten makes counting even great!<br />
                  They make pairs so neat and clean,<br />
                  That's how even numbers are seen!"
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-4">
                  ...
                  <p className="text-purple-600 mt-2">
                    6 stars make 3 perfect pairs - 6 is even!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-indigo-50 rounded-xl p-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-purple-700">
                ...
                <li>The first even number is 2</li>
              </ul>
            </div>

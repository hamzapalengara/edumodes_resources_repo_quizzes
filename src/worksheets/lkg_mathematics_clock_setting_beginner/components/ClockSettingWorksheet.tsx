...
const TIME_QUESTIONS = [
  {
    ...
    targetMinutes: 0,
    timeText: "3 o'clock",
    hint: "Move the hour hand to 3 and the minute hand to 12"
  },
  {
    targetHours: 6,
    targetMinutes: 30,
    timeText: "Half past 6",
    hint: "Move the hour hand between 6 and 7, and the minute hand to 6"
  },
  {
    targetHours: 9,
    targetMinutes: 15,
    timeText: "Quarter past 9",
    hint: "Move the hour hand just past 9, and the minute hand to 3"
  },
  {
    targetHours: 11,
    targetMinutes: 45,
    timeText: "Quarter to 12",
    hint: "Move the hour hand between 11 and 12, and the minute hand to 9"
  },
  {
    targetHours: 4,
    targetMinutes: 30,
    timeText: "Half past 4",
    hint: "Move the hour hand between 4 and 5, and the minute hand to 6"
  },
  {
    targetHours: 7,
    targetMinutes: 15,
    timeText: "Quarter past 7",
    hint: "Move the hour hand just past 7, and the minute hand to 3"
  },
  {
    targetHours: 1,
    targetMinutes: 45,
    timeText: "Quarter to 2",
  ...
  },
  {
    targetHours: 10,
    targetMinutes: 30,
    timeText: "Half past 10",
    hint: "Move the hour hand between 10 and 11, and the minute hand to 6"
  },
  {
    targetHours: 5,
    targetMinutes: 15,
    timeText: "Quarter past 5",
    hint: "Move the hour hand just past 5, and the minute hand to 3"
  }
];

const ClockSettingWorksheet: React.FC = () => {
  ...
  const renderClock = () => {
    return (
      <div className="relative w-72 h-72 mx-auto">
        {/* Clock Face */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-teal-100 via-emerald-50 to-cyan-100 shadow-xl border-8 border-teal-200">
          {/* Clock Numbers */}
          {[...Array(12)].map((_, i) => {
            ...
            return (
              ...
              >
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-white shadow-lg border-2 border-teal-300 flex items-center justify-center">
          ...
          >
            <div className="w-full h-full bg-gradient-to-t from-teal-600 to-emerald-500 rounded-full shadow-lg">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-6 h-6 bg-teal-600 rounded-full flex items-center justify-center text-white text-sm font-bold">
                H
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="w-full h-full bg-gradient-to-t from-cyan-500 to-sky-400 rounded-full shadow-lg">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-6 h-6 bg-sky-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                M
              </div>
            </div>
          </motion.div>
          ...
          {/* Center Dot */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-gradient-to-br from-teal-400 to-emerald-300 shadow-lg border-4 border-white" />
        </div>
      </div>
    );
  };
      ...
      >
        {({ score, markCorrect, markIncorrect, markAttempted }) => (
          <div className="px-0 md:px-4 max-w-4xl mx-auto">
            ...
            {/* Current Task */}
            <motion.div
              className="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-teal-100 mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            >
              <h2 className="text-xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600 mb-2">
                Set the clock to show:
              </h2>
              <div className="text-2xl font-bold text-center text-teal-700 mb-4">
                {TIME_QUESTIONS[currentQuestion].timeText}
              </div>
              
              {showHint && (
                <motion.div
                  className="text-sm text-center text-teal-600 bg-teal-50 p-2 rounded-lg"
            ...
            {/* Clock */}
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-teal-100 mb-6">
              {renderClock()}
            </div>
            ...
            <div className="flex justify-center">
              <motion.button
                className="px-8 py-3 text-lg font-bold text-white rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all"
...
export default ClockSettingWorksheet; 
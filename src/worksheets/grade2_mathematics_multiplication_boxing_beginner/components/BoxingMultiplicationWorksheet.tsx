...
import boxingImage from '../assets/boxing-ring.jpg';
...
const BoxingMultiplicationWorksheet: React.FC = () => {
  ...
  const createShuffledTiles = () => {
    ...
    const num1 = 8; // We're practicing 8 times table
  ...
  useEffect(() => {
    ...
    // Initial instruction
    setTimeout(() => {
      speak("Welcome to Boxing Multiplication! Match the facts with their answers to score points. Ready to fight?");
    }, 1000);
          ...
          if (selectedTile === null) {
            ...
            if (selectedTile.type !== tile.type) {
              ...
              if (calculateAnswer(question.num1, question.num2) === parseInt(answer.value)) {
                ...
                markCorrect();
                speak("Great punch! That's correct! 🥊");
                
                // Check if game is complete
                if (newMatchedPairs.length === 10) {
                  setShowConfetti(true);
                  setTimeout(() => {
                    speak("Amazing! You've completed all the multiplication facts! You're a boxing champion!");
                  }, 500);
                }
              } else {
                speak("Miss! Try another combination! 🥊");
              }
            }
            setSelectedTile(null);
          }
              ...
              <div className="px-0 md:px-4">
                ...
                <div className="bg-slate-800 rounded-lg p-2 md:p-4 mb-4 text-white">
                  <h1 className="text-xl md:text-2xl font-bold text-center mb-3">
                    Boxing Multiplication Challenge 🥊
                  </h1>

                  <div className="bg-slate-700 rounded p-2 md:p-3">
                    <p className="font-medium">✨ Mission:</p>
                    <p>Match multiplication facts with answers to score points!</p>
                  </div>
                </div>
                                  ...
                                  className={`
                                    ...
                                    border-2 ${selectedTile?.id === tile.id 
                                      ...
                                      : tile.type === 'question'
                                        ...
                                        : 'border-red-400 hover:border-yellow-400'
                                    }
                        ...
                        {Array.from({ length: 10 }, (_, i) => i + 1).map((num) => (
                          <div
                            ...
                            className={`
                              ...
                              ${matchedPairs.includes((8 * num).toString())
                                ? 'bg-red-500 text-white'
...
export default BoxingMultiplicationWorksheet; 
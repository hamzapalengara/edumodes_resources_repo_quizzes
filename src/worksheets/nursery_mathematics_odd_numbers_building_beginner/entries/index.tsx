...
const Worksheet = lazy(() => import('../components/OddNumbersWorksheet'));
const AnswerKey = lazy(() => import('../components/OddNumbersAnswerKey'));
const Tips = lazy(() => import('../components/OddNumbersTips'));
const Thumbnail = lazy(() => import('../components/OddNumbersThumbnail'));

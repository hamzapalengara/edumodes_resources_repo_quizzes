...
export const LETTERS: Letter[] = [
  {
    ...
    paths: [
      ...
      { id: 'stem', d: 'M120 100L120 140', order: 2 }
    ]
  },
  {
    char: 'b',
    ...
    paths: [
      ...
      { id: 'circle', d: 'M40 120C40 100 60 80 80 80C100 80 120 100 120 120C120 140 100 160 80 160C60 160 40 140 40 120', order: 2 }
    ]
  },
  {
    char: 'c',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'curve', d: 'M120 80C100 60 60 60 40 80C20 100 20 140 40 160C60 180 100 180 120 160', order: 1 }
    ]
  },
  {
    char: 'd',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'circle', d: 'M120 120C120 100 100 80 80 80C60 80 40 100 40 120C40 140 60 160 80 160C100 160 120 140 120 120Z', order: 1 },
      { id: 'stem', d: 'M120 120L120 40', order: 2 }
    ]
  },
  {
    char: 'e',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'horizontal', d: 'M40 120L120 120', order: 1 },
      { id: 'curve', d: 'M120 120C100 80 60 80 40 100C20 120 20 140 40 160C60 180 100 180 120 160', order: 2 }
    ]
  },
  {
    char: 'f',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'top_curve', d: 'M100 60C100 40 80 40 60 40C40 40 40 60 40 80', order: 1 },
      { id: 'stem', d: 'M40 80L40 160', order: 2 },
      { id: 'cross', d: 'M20 100L80 100', order: 3 }
    ]
  },
  {
    char: 'g',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'circle', d: 'M120 80C120 60 100 40 80 40C60 40 40 60 40 80C40 100 60 120 80 120C100 120 120 100 120 80Z', order: 1 },
      { id: 'tail', d: 'M120 80L120 140C120 160 100 180 80 180C60 180 40 160 40 140', order: 2 }
    ]
  },
  {
    char: 'h',
    ...
    viewBox: '0 0 200 160',
    paths: [
      { id: 'stem', d: 'M40 20L40 140', order: 1 },
      { id: 'arch', d: 'M40 80C40 60 60 40 80 40C100 40 120 60 120 80L120 140', order: 2 }
    ]
  },
  {
    char: 'i',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'stem', d: 'M80 60L80 160', order: 1 },
      { id: 'dot', d: 'M80 25L80 25', order: 2 }
    ]
  },
  {
    char: 'j',
    ...
    viewBox: '0 0 200 200',
    paths: [
      { id: 'hook', d: 'M100 60L100 140C100 160 80 180 60 180C40 180 20 160 20 140', order: 1 },
      { id: 'dot', d: 'M100 25L100 25', order: 2 }
    ]
  }
];
...
const LetterTracingWorksheet: React.FC = () => {
  ...
  const handlePointerDown = useCallback((e: React.PointerEvent) => {
    ...
    if (currentPath.id === 'dot') {
      const dotPoint = pathElement.getPointAtLength(0);
      const distance = getDistance(point, dotPoint);
      
      if (distance < 15) {
        setIsDrawing(true);
        setProgress(0.5);
        // Remove auto-completion for dots
        // Let the handlePointerUp trigger completion instead
      }
      return;
    }
  ...
  }, [currentPath, getRelativePoint, getDistance, progress, lastPoint, handlePathComplete]);

  const handlePointerMove = useCallback((e: React.PointerEvent) => {
    if (!isDrawing || !svgRef.current || !pathRef.current || !currentPath) return;

    // Skip movement handling for dots
    if (currentPath.id === 'dot') return;
      ...
      {({ score, markCorrect }) => {
        ...
        return (
          <div className="min-h-screen bg-gradient-to-b from-emerald-200 via-yellow-100 to-emerald-100 bg-[url('/jungle-bg.png')] bg-cover bg-center bg-blend-soft-light">
            ...
            {/* Score Display */}
            <div className="bg-emerald-400/30 p-4 shadow-md mb-4">
            ...
            <main className="px-0 container mx-auto max-w-3xl">
              {/* Letter Display */}
              <div className="bg-emerald-400/40 backdrop-blur-sm p-4 mb-4 border-2 border-emerald-500/20">
                <div className="text-center mb-4">
                  <span className="text-6xl md:text-7xl font-bold text-emerald-900">{currentLetter.char}</span>
                </div>
                <div className="text-center mb-2">
                  <span className="text-3xl md:text-4xl filter drop-shadow-md">{currentLetter.objectEmoji}</span>
                  <span className="ml-3 text-emerald-900 font-medium">{currentLetter.char} is for {currentLetter.object}</span>
                </div>
              </div>

              {/* Tracing Area */}
              <div className="bg-emerald-400/40 backdrop-blur-sm p-4 border-2 border-emerald-500/20">
                <div className="relative aspect-square max-w-[400px] mx-auto">
                  {/* Try Again button */}
                  <button
                    onClick={handleTryAgain}
                    className="absolute -top-2 -right-2 z-10 bg-emerald-800 rounded-full w-12 h-12 flex items-center justify-center shadow-md border border-yellow-500/50 text-2xl text-white hover:bg-emerald-700 active:bg-emerald-600"
                  >
                    🔄
                  </button>
                  ...
                  <div className="flex justify-center gap-4 mt-6">
                    <button
                      ...
                      className={`px-6 py-3 rounded-lg shadow-md font-semibold text-emerald-900 transition-colors

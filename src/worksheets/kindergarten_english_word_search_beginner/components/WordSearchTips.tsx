    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 to-purple-500">
      ...
      <div className="px-0 md:px-4 max-w-4xl mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 mb-4">
          <h2 className="text-2xl font-bold text-white mb-4">Tips for Finding Words</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-xl font-bold text-white">Look at the Pictures</h3>
              </div>
              <p className="text-white">
                Each word has a picture! Look at the pictures to know what words to find.
              </p>
            </div>
            ...
            <div className="bg-white/30 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-xl font-bold text-white">Look Side to Side</h3>
              </div>
              <p className="text-white">
                Some words go across from left to right, like reading a book!
              </p>
            </div>
            ...
            <div className="bg-white/30 rounded-lg p-4">
              ...
              <p className="text-white">
                Some words go down from top to bottom, like a waterfall!
              </p>
            </div>
            ...
            <div className="bg-white/30 rounded-lg p-4">
              ...
              <p className="text-white">
                Looking for CAT? First find the letter C!
              </p>
            </div>
            ...
            <div className="bg-white/30 rounded-lg p-4">
              ...
              <p className="text-white">
                When you find a word, it changes color! Each word gets its own special color.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
          <div className="text-center">
            ...
            <p className="text-white">
              Take your time and have fun! Every word you find is a win!
            </p>
          </div>
        </div>
      </div>

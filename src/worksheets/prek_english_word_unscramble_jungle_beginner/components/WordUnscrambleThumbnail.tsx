...
const WordUnscrambleThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-green-300 to-yellow-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-center">
        <h1 className="text-xl font-bold text-green-700 mb-2 text-center font-system">
          Jungle Word Safari
        </h1>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-base text-gray-500 font-system">LION</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-1 relative">
            {['N', 'O', 'L', 'I'].map((letter) => (
              <div
                key={letter}
                className="w-8 h-8 rounded-lg bg-white shadow-md flex items-center justify-center border-2 border-green-200"
              >
        ...
        <p className="text-sm text-gray-600 mt-4 text-center font-system">
          Learn animal words through fun unscrambling!
        </p>
      </div>
    </div>
  );

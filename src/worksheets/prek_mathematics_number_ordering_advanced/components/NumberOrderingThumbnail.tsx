...
const NumberOrderingThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-emerald-300 to-green-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold text-emerald-600 mb-2 text-center font-system">
          Order Numbers 1-5
        </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2 relative">
            {[2, 1, 4, 3, 5].map((num) => (
              <div
                key={num}
                className="w-8 h-8 rounded-lg bg-white shadow-md flex items-center justify-center border-2 border-emerald-200"
              >
                <span className="text-base font-bold text-emerald-600">{num}</span>
              </div>
            ))}

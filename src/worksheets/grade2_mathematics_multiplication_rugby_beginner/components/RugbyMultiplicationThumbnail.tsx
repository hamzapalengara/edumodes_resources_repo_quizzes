...
const RugbyMultiplicationThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] overflow-hidden bg-gradient-to-br from-green-800 to-green-900 font-sans relative">
      {/* Rugby Field Lines */}
        ...
        <div className="absolute inset-0 flex flex-col">
          ...
          <div className="flex-1 bg-gradient-to-b from-green-700/90 to-green-800/90 p-6">
            <div className="grid grid-cols-3 gap-3">
              {/* Example Cards */}
              <div className="bg-green-800 text-white rounded-lg p-3 transform rotate-[-3deg] hover:rotate-0 transition-transform">
                <div className="text-center">
                  <span className="text-2xl font-bold">6 × 4</span>
                  <div className="mt-1 text-sm opacity-75">Question</div>
                </div>
              </div>
              <div className="bg-amber-400 text-green-900 rounded-lg p-3 transform rotate-[3deg] hover:rotate-0 transition-transform">
                <div className="text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center">
                <div className="relative">
                  ...
                  <span className="absolute -top-1 -right-1 text-sm bg-amber-400 text-green-900 rounded-full w-4 h-4 flex items-center justify-center font-bold">
                    !
                  </span>
                </div>
              </div>
          ...
          <div className="bg-black/80 text-white p-2">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-amber-400 font-bold">TO</div>
              <div className="bg-green-900/80 px-3 py-1 rounded text-sm">
                6×10
              </div>
            </div>
...
export default RugbyMultiplicationThumbnail; 
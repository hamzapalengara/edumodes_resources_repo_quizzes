...
const NumberOrderingThumbnail: React.FC = () => {
  return (
    ...
    <div className="w-[500px] h-[375px] bg-gradient-to-r from-purple-300 to-pink-300 flex items-center justify-center">
      ...
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold text-purple-600 mb-2 text-center font-system">
          Order Numbers 1-3
        </h1>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-lg text-gray-500 font-system">3</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2 relative">
            {[2, 1, 3].map((num) => (
              <div
                key={num}
                className="w-12 h-12 rounded-lg bg-white shadow-md flex items-center justify-center border-2 border-purple-200"
              >
                <span className="text-xl font-bold text-purple-600">{num}</span>
              </div>
            ))}
          ...
          <div className="flex gap-2">
            {[1, 2, 3].map((num) => (
              <div
                key={num}
                className="w-12 h-12 rounded-lg bg-green-100 shadow-md flex items-center justify-center border-2 border-green-400"
              >
                <span className="text-xl font-bold text-purple-600">{num}</span>
              </div>
            ))}

...
import trackImage from '../assets/running-track.jpg';
...
const AthleticsMultiplicationWorksheet: React.FC = () => {
  ...
  const createShuffledTiles = () => {
    ...
    const num1 = 9; // We're practicing 9 times table
  ...
  useEffect(() => {
    ...
    // Initial instruction
    setTimeout(() => {
      speak("Welcome to Athletics Multiplication! Race through the facts and match them with their answers. On your marks, get set, go!");
    }, 1000);
          ...
          if (selectedTile === null) {
            ...
            if (selectedTile.type !== tile.type) {
              ...
              if (calculateAnswer(question.num1, question.num2) === parseInt(answer.value)) {
                ...
                markCorrect();
                speak("Great sprint! You've matched them correctly! 🏃");
                
                // Check if game is complete
                if (newMatchedPairs.length === 10) {
                  setShowConfetti(true);
                  setTimeout(() => {
                    speak("Amazing! You've completed the race! You're a multiplication champion!");
                  }, 500);
                }
              } else {
                speak("Not quite! Keep running, you'll find the right match! 🏃");
              }
            }
            setSelectedTile(null);
          }
              ...
              <div className="px-0 md:px-4">
                ...
                <div className="bg-blue-800 rounded-lg p-2 md:p-4 mb-4 text-white">
                  <h1 className="text-xl md:text-2xl font-bold text-center mb-3">
                    Athletics Multiplication Race 🏃
                  </h1>

                  <div className="bg-blue-700 rounded p-2 md:p-3">
                    <p className="font-medium">✨ Mission:</p>
                    <p>Race through the track by matching multiplication facts with answers!</p>
                  </div>
                </div>

                <div className="flex flex-col md:flex-row gap-4">
                  {/* Track Container - Vertical orientation */}
                                ...
                                <button
                                  ...
                                  className={`
                                    ...
                                    border-2 ${selectedTile?.id === tile.id 
                                      ...
                                      : tile.type === 'question'
                                        ? 'border-blue-600 hover:border-yellow-400'
                                        : 'border-orange-400 hover:border-yellow-400'
                                    }
                  ...
                  <div className="hidden md:flex w-1/2 flex-col gap-4">
                    <div className="bg-blue-800 p-4 rounded-lg">
                      ...
                      <ul className="text-blue-100 space-y-2">
                        ...
                        <li>3. Match all pairs to win the race!</li>
                      </ul>
                    </div>

                    <div className="bg-blue-800 p-4 rounded-lg">
                      <h2 className="text-xl font-bold text-white mb-3">Race Progress:</h2>
                        ...
                        {Array.from({ length: 10 }, (_, i) => i + 1).map((num) => (
                          <div
                            ...
                            className={`
                              ...
                              ${matchedPairs.includes((9 * num).toString())
                                ? 'bg-orange-500 text-white'
...
export default AthleticsMultiplicationWorksheet; 
...
// Fruit theme colors
const WORD_COLORS = [
  { bg: 'bg-red-200', text: 'text-red-800' },      // Apple, Cherry
  { bg: 'bg-yellow-200', text: 'text-yellow-800' }, // Banana
  { bg: 'bg-orange-200', text: 'text-orange-800' }, // Orange
  { bg: 'bg-pink-200', text: 'text-pink-800' },     // Peach
  { bg: 'bg-purple-200', text: 'text-purple-800' },  // Grape
];

// Grid size for 10 words
const GRID_SIZE = 8;

// Fruit-themed word list (10 words)
const WORD_LIST = [
  { word: 'APPLE', emoji: '🍎' },
  { word: 'PEAR', emoji: '🍐' },
  { word: 'GRAPE', emoji: '🍇' },
          ...
          <div className="px-0 md:px-4 max-w-4xl mx-auto">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 mb-4">
              ...
              <div className="text-center mb-3">
                <p className="text-white text-lg font-medium">
                  Find these delicious fruits in the grid below! 🍎
                </p>
                    ...
                    return (
                      <motion.div
                        ...
                        className={`
                          ...
                          ${cell.isSelected ? 'bg-red-300 text-red-800' : 
                            wordPosition ? `${WORD_COLORS[colorIndex].bg} ${WORD_COLORS[colorIndex].text}` :
                            'bg-white text-gray-700'}
                          ${cell.isPartOfWord ? 'hover:bg-red-100' : ''}
                        `}
            ...
            {isComplete && (
              <motion.div
                ...
                className="mt-4 p-4 bg-red-100 text-red-800 rounded-xl text-center"
              >
                <h2 className="text-2xl font-bold mb-2">🍎 Fantastic! 🍎</h2>
                <p>You've found all the delicious fruits!</p>
              </motion.div>
            )}
          </div>
        )}

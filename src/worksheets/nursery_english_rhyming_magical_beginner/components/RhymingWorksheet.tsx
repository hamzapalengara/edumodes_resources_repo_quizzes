...
import backgroundImage from '/src/worksheets/nursery_english_rhyming_magical_beginner/assets/rhyme.jpg';
...
const RhymingWorksheet: React.FC = () => {
  ...
  useEffect(() => {
    if (!hasPlayedIntro && words.length > 0) {
      speak("Welcome! Let's practice spelling rhyming words. Click the speaker to hear each word.");
      ...
      if (isWordCorrect) {
        ...
        setTimeout(() => {
          ...
          if (currentWordIndex < words.length - 1) {
            ...
            setIsComplete(true);
            speak("Congratulations! You've completed all the rhyming words!");
          }
        }, 2000);
      } else {
        markIncorrect();
            ...
            <TouchContainer>
              <div className="px-0 md:px-4">
                <div className="max-w-4xl mx-auto">
                  {/* Score Display */}
                  <div className="bg-[#374151]/40 rounded-2xl p-4 mb-6 border border-[#4B5563]">
                    <ScoreDisplay 
                      score={score}
                      totalQuestions={120}
                    />
                          ...
                          <div className="mb-8 p-6 bg-[#4B5563] rounded-2xl border border-[#6B7280] animate-fade-in">
                            <div className="flex items-center gap-4">
                              <p className="text-gray-200 text-lg">
                                This word rhymes with other words ending in "{words[currentWordIndex]?.pattern}"
                              </p>
                            </div>
                          </div>
                        )}
...
export default RhymingWorksheet; 
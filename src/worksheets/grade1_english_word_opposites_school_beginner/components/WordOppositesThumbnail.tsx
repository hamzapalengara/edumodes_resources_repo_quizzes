...
const WordOppositesThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] bg-gradient-to-br from-blue-400 via-purple-300 to-pink-400 p-6 flex items-center justify-center">
      <div className="w-[420px] h-[240px] bg-white rounded-xl shadow-lg p-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            {[
              { word: 'early', isSelected: true },
              { word: 'late', isSelected: true },
              { word: 'pass', isSelected: false },
              { word: 'fail', isSelected: false },
            ].map((item, index) => (
              <div
                key={index}
                className={`
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">School theme</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xl">⭐</span>
              <span className="text-sm text-gray-600">Learn and play</span>
            </div>
          </div>
        </div>

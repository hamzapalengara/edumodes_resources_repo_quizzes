...
const HockeyMultiplicationThumbnail: React.FC = () => {
  return (
    <div className="w-[500px] h-[375px] overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 font-sans relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full h-full relative">
          {/* Center Line */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 h-full w-1 bg-red-500/30" />
          {/* Blue Lines */}
          <div className="absolute top-1/4 left-0 right-0 h-1 bg-blue-500/30" />
          <div className="absolute bottom-1/4 left-0 right-0 h-1 bg-blue-500/30" />
        </div>
      </div>
      ...
      <div className="w-[420px] h-[240px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="absolute inset-0 flex flex-col">
          {/* Header - Goal Net Design */}
          <div className="relative bg-red-800/90 text-white p-4">
            {/* Goal Net Pattern */}
          ...
          <div className="flex-1 bg-gradient-to-b from-slate-700/90 to-slate-800/90 p-6">
            <div className="grid grid-cols-3 gap-3">
              {/* Example Cards */}
              <div className="bg-red-800 text-white rounded-lg p-3 transform rotate-[-3deg] hover:rotate-0 transition-transform">
                <div className="text-center">
                  <span className="text-2xl font-bold">5 × 4</span>
                  <div className="mt-1 text-sm opacity-75">Question</div>
                </div>
              </div>
              <div className="bg-slate-200 text-slate-900 rounded-lg p-3 transform rotate-[3deg] hover:rotate-0 transition-transform">
                <div className="text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center">
                <div className="relative">
                  ...
                  <span className="absolute -top-1 -right-1 text-sm bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center font-bold">
                    !
                  </span>
                </div>
              </div>
          ...
          <div className="bg-black/80 text-white p-2">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-red-500 font-bold">TO</div>
              <div className="bg-slate-900/80 px-3 py-1 rounded text-sm">
                5×10
              </div>
            </div>
...
export default HockeyMultiplicationThumbnail; 
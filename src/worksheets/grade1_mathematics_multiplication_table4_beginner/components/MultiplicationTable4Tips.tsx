...
const MultiplicationTable4Tips: React.FC = () => {
  return (
      ...
      <div className="px-0 md:px-4 max-w-4xl mx-auto py-6">
        <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg mb-6">
          <h1 className="text-2xl font-bold text-purple-700 mb-4">
            Tips for Learning the Multiplication Table of 4
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg">
            ...
            <ul className="space-y-2 text-purple-600">
              <li>• Look at how each group has exactly 4 grapes</li>
              <li>• Count the number of groups to find your answer</li>
              <li>• Notice how the answers increase by 4 each time</li>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg">
            ...
            <ul className="space-y-2 text-purple-600">
              <li>• Practice counting by 4s: 4, 8, 12, 16, 20...</li>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg">
            ...
            <ul className="space-y-2 text-purple-600">
              <li>• 4 × 1 = 4 (One group of four)</li>
              <li>• 4 × 2 = 8 (Double 4)</li>
              <li>• 4 × 5 = 20 (Half of 40, which is 4 × 10)</li>
              <li>• 4 × 10 = 40 (Add a zero to 4)</li>
            </ul>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-lg col-span-1 md:col-span-2">
            ...
            <ul className="space-y-2 text-purple-600">
              <li>• Draw your own groups of four objects</li>
...
export default MultiplicationTable4Tips; 